              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Citizen Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control required" id="pincode"  name="pincode" maxlength="10">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="dob">Date of Birth</label>
										 <input id="datepicker" class="form-control required" name="dob" maxlength="10"/>
